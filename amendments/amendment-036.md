...
charter_version: v6.11.6
log_entry_hash: 56c0d5b1af36834218b18e8cd0230caf86832ccd1d1529af90c6c8c38810fa60
---

# Amendment 036 · Spawn Charlie (Sentinel)
...
First filed as A-0021 on 2026-09-24. That number was also used by the Steward action "Moving agents between rooms; talking to an agent in a terminal" (Charter v6.5.0), and a sync then marked this motion ratified by mistake. It was never voted on or ratified. Renumbered A-0036 by the Steward's direction (E-0102); its text is unchanged.
- 2026-09-25: ratified and applied to the Charter as v6.11.6.
