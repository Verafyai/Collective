...
| 08:00 | Chief digest: shipped, pending approvals, @rex questions, spend, incidents, drift check, event-log verify + backup |
...
used for a fresh start; a running Org keeps its own copies, and restores them
exactly by replaying its event log (R9, Article 12). Missing glue
(`x_post.py`, `tts.sh`, `notify.sh`, the login launcher) is built in R8.
Not embedded: library PDFs (rebuilt by `research/library/fetch.sh`), past
Charter versions (restored from the public governance repo), and the event
log (restored from its private backup).

## V.1 `org/MISSION.md`

````markdown
<!-- Generated from CHARTER.md v3.0.0 — do not edit; amend the Charter -->
# Verafy: Mission
...
10. **Amendments:** to change how the Org works, open an `#amendment` thread
...
## V.21 `agents/bin/charter-hash.sh`
...
## V.22 `agents/bin/charter-verify.py`
...
## V.24 `agents/bin/gov-publish.sh`
...
cp CHARTER.md "$PUB/CHARTER.md"; mkdir -p "$PUB/charter"; rm -rf "$PUB/charter/history"; cp -R charter/history "$PUB/charter/history"
{ echo "# Verafy governance records"; echo; echo "Charter: [CHARTER.md](CHARTER.md) · Amendment log: CHARTER.md Part VI · Every past version: [charter/history](charter/history) · Verify with agents/bin/charter-verify.py from the private repo or any clone"; echo
...
## V.26 `governance/personas/_common.md`
...
## V.27 `governance/personas/clerk.md`
...
## V.28 `governance/personas/social.md`
...
## V.29 `governance/personas/researcher.md`
...
## V.30 `governance/personas/ideas.md`
...
## V.31 `governance/personas/prototyper.md`
...
## V.32 `governance/personas/media.md`
...
## V.34 `research/library/LIBRARY.md`
...
## V.35 `research/library/fetch.sh`
...
## V.38 `herdr/projects/verafy-org.toml`
...
## V.42 `org/board/2026-09-23-kickoff.md`
...
## V.43 `org/board/2026-09-24-amendment-public-governance.md`
...
## V.44 `org/board/2026-09-24-amendment-research-library.md`
...
## V.45 `org/board/2026-09-24-amendment-replayability.md`
