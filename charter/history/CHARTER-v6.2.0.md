...
18.7 **Human input on projects.** The dashboard's one write is a comment or
suggestion on a project, appended to that project's `discussion.md` as
`human:<name>` and recorded as an event (Article 21.4). It changes no other
record. The public release, which can't accept writes, links to GitHub
Discussions, and the Scribe imports those comments weekly.
...
PM_TOOLS="Read,Write,Edit,Glob,Grep,Bash(tsk:*),Bash(date:*),Bash(python3 agents/bin/sprint.py:*),Bash(python3 agents/bin/edict.py replay:*),Bash(python3 agents/bin/case.py search:*),Bash(python3 agents/bin/case.py show:*),Bash(python3 agents/bin/projects.py list:*),Bash(python3 agents/bin/projects.py show:*)"
SCRIBE_TOOLS="Read,Write,Edit,Glob,Grep,Bash(date:*),Bash(git log:*),Bash(git -C private log:*),Bash(git diff:*),Bash(python3 agents/bin/case.py:*),Bash(python3 agents/bin/sprint.py:*),Bash(python3 agents/bin/gov-tally.py:*),Bash(agents/bin/gov-publish.sh:*),Bash(agents/bin/charter-hash.sh:*),Bash(agents/bin/charter-verify.py:*),Bash(python3 agents/bin/charter.py:*),Bash(python3 agents/bin/weekly-digest.py:*),Bash(python3 agents/bin/edict.py note:*),Bash(python3 agents/bin/edict.py replay:*),Bash(python3 agents/bin/amendment.py:*),Bash(python3 agents/bin/projects.py comment:*),Bash(python3 agents/bin/projects.py index:*)"
LAWYER_TOOLS="Read,Write,Edit,Glob,Grep,Bash(python3 agents/bin/case.py search:*),Bash(python3 agents/bin/case.py show:*),Bash(python3 agents/bin/case.py stats:*),Bash(python3 agents/bin/sprint.py status:*),Bash(python3 agents/bin/amendment.py new:*),Bash(python3 agents/bin/projects.py comment:*),Bash(python3 agents/bin/projects.py show:*)"
AUDITOR_TOOLS="Read,Glob,Grep,Write,Bash(date:*),Bash(agents/bin/charter-verify.py:*),Bash(python3 agents/bin/eventlog.py verify:*),Bash(python3 agents/bin/edict.py check:*),Bash(python3 agents/bin/case.py check:*),Bash(agents/bin/seed-check.sh:*),Bash(python3 agents/bin/charter.py materialize --dry-run:*),Bash(agents/bin/repos.sh commit:*),Bash(agents/bin/ledger-backup.sh:*),Bash(python3 agents/bin/metrics.py:*),Bash(python3 agents/bin/playback.py:*),Bash(python3 agents/bin/amendment.py check:*),Bash(python3 agents/bin/projects.py check:*),Bash(python3 agents/bin/projects.py comment:*)"
RESEARCHER_TOOLS="Read,Write,Edit,Glob,Grep,WebSearch,WebFetch,Bash(tsk:*),Bash(python3 agents/bin/case.py search:*),Bash(python3 agents/bin/case.py show:*),Bash(python3 agents/bin/sprint.py status:*),Bash(python3 agents/bin/sprint.py check:*),Bash(python3 agents/bin/amendment.py new:*),Bash(python3 agents/bin/projects.py comment:*),Bash(python3 agents/bin/projects.py show:*)"
IDEAS_TOOLS="Read,Write,Edit,Glob,Grep,Bash(tsk:*),Bash(python3 agents/bin/case.py search:*),Bash(python3 agents/bin/case.py show:*),Bash(python3 agents/bin/sprint.py status:*),Bash(python3 agents/bin/sprint.py check:*),Bash(python3 agents/bin/amendment.py new:*),Bash(python3 agents/bin/projects.py comment:*),Bash(python3 agents/bin/projects.py show:*)"
PROTOTYPER_TOOLS="Read,Write,Edit,Glob,Grep,Bash(git:*),Bash(npm:*),Bash(node:*),Bash(python3:*),Bash(uv:*),Bash(make:*),Bash(tsk:*),Bash(python3 agents/bin/case.py search:*),Bash(python3 agents/bin/case.py show:*),Bash(python3 agents/bin/sprint.py status:*),Bash(python3 agents/bin/sprint.py check:*),Bash(python3 agents/bin/projects.py version:*),Bash(python3 agents/bin/projects.py release:*),Bash(python3 agents/bin/projects.py comment:*),Bash(python3 agents/bin/projects.py show:*)"
MEDIA_TOOLS="Read,Write,Edit,Glob,Grep,Bash(ffmpeg:*),Bash(ffprobe:*),Bash(npx playwright:*),Bash(node:*),Bash(python3:*),Bash(tsk:*),Bash(agents/bin/tts.sh:*),Bash(python3 agents/bin/case.py search:*),Bash(python3 agents/bin/case.py show:*),Bash(python3 agents/bin/sprint.py status:*),Bash(python3 agents/bin/sprint.py check:*),Bash(python3 agents/bin/amendment.py new:*),Bash(python3 agents/bin/projects.py comment:*),Bash(python3 agents/bin/projects.py show:*)"
...
if [ $MODE = herdr ]; then
  say "4) herdr"
  if ! herdr plugin list 2>/dev/null | grep -qi herdr-plus; then
    run "herdr plugin install cloudmanic/herdr-plus" && ok "installed herdr-plus"
  else ok "herdr-plus installed"; fi
  cfg="$(herdr plugin config-dir cloudmanic.herdr-plus 2>/dev/null || true)"
  if [ -z "$cfg" ] && [ $DRY = 0 ]; then die "couldn't find herdr-plus's config folder; is herdr ≥ 0.7 running?"; fi
  ...
  echo
  warn "herdr-plus couldn't reach a running herdr."
  echo "   Start herdr in this folder, then run ./launch.sh again inside its first pane:"
  echo "       cd \"$ROOT\" && herdr"
  echo "   Or use the tmux fallback now:  ./launch.sh --tmux"
  exit 1
fi
...
## V.85 `org/board/2026-09-25-amendment-offices.md`
...
## V.86 `org/board/2026-09-25-amendment-projects.md`
...
## V.87 `org/board/2026-09-24-task-T-0001-dashboard.md`
...
## V.88 `org/board/2026-09-24-task-T-0002-user-guide-and-blog.md`
...
## V.89 `org/cases/C-0001-launch-sequence-and-draft-only-social.md`
...
## V.90 `org/cases/C-0002-public-governance-via-fusion-harness.md`
...
## V.91 `org/cases/C-0003-proposals-must-cite-the-research-library.md`
...
## V.92 `org/cases/C-0004-everything-is-a-replayable-event.md`
...
## V.93 `org/cases/C-0005-decisions-become-binding-case-law.md`
...
## V.94 `org/cases/C-0006-the-collective-dashboard-is-mandated.md`
...
## V.95 `org/cases/C-0007-the-collective-documents-itself.md`
...
## V.96 `org/cases/C-0008-the-twelve-founding-principles.md`
...
## V.97 `org/cases/C-0009-the-offices-of-the-collective.md`
...
## V.98 `org/cases/C-0010-amendments-as-files-and-projects-as-iterated-produ.md`
...
## V.107 `projects/001-dashboard/PROJECT.md`
...
## V.108 `projects/001-dashboard/spec.md`
...
## V.109 `projects/001-dashboard/versions/version-001.md`
...
## V.110 `projects/001-dashboard/discussion.md`
